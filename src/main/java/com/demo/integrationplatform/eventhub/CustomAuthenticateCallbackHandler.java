package com.demo.integrationplatform.eventhub;
...
public class CustomAuthenticateCallbackHandler implements AuthenticateCallbackHandler {
    ...
    public void configure(Map<String, ?> configs, String mechanism, List<AppConfigurationEntry> jaasConfigEntries) {
        ...
        this.authority = "https://login.chinacloudapi.cn/3953396c-814c-4dbe-b543-ae4999978206/"; // replace <tenant-id> with your tenant id
        this.appId = "14f2bfb2-9a19-4c9a-9e19-4bc1319a119a"; // also called client id
        this.appSecret = "15-2jni.F1_.B4GqN-OVtHXY13Z3uYK8-f"; // also called client secret
    }
